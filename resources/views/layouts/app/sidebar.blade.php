  ...
  <div id="sidebar" class="sidebar sidebar-with-footer">
    ...
    <div class="sidebar-scrollbar">
      ...
      <ul class="nav sidebar-inner" id="sidebar-menu">
          ...
          <li  class="has-sub @if(request()->is('admins') || request()->is('admins/*') || request()->is('vendors') || 
          request()->is('vendors/*') || request()->is('buyers') || request()->is('buyers/*'))active @endif expand" >
            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#user_management"
              aria-expanded="false" aria-controls="user_management">
              <i class="mdi mdi-view-dashboard-outline"></i>
              <span class="nav-text">User Management</span> <b class="caret"></b>
            </a>
            <ul  class="collapse"  id="user_management"
              data-parent="#sidebar-menu">
              <div class="sub-menu">
                
                
                  
                    <li  class="@if(request()->is('admins') || request()->is('admins/*'))active @endif" >
                      <a class="sidenav-item-link" href="/admins">
                        <span class="nav-text">Admins</span>
                        
                      </a>
                    </li>
                  
                    <li class="@if(request()->is('vendors') || request()->is('vendors/*'))active @endif">
                      <a class="sidenav-item-link" href="/vendors">
                    ...
                    <li class="@if(request()->is('buyers') || request()->is('buyers/*'))active @endif">
                      <a class="sidenav-item-link" href="/buyers">
          ...
          request()->is('businesses/*'))active @endif expand" >
            ...
            <ul  class="collapse"  id="business_management"
              data-parent="#sidebar-menu">
              <div class="sub-menu">
                  
                <li class="@if(request()->is('businesses') || request()->is('businesses/*'))active @endif">
                  <a class="sidenav-item-link" href="/businesses">
                  ...
                  <li  class="@if(request()->is('business-categories') || request()->is('business-categories/*'))active @endif" >
                    <a class="sidenav-item-link" href="/business-categories">
                      <span class="nav-text">Business Category</span>
...
{{--         
          <li  class="has-sub" >
            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#ui-elements"
              ...
              <span class="nav-text">UI Management</span> <b class="caret"></b>
            </a>
