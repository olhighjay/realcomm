...
@section('main')
  <main class="main">
    <section class="home-slider owl-carousel owl-theme owl-carousel-lazy text-uppercase nav-big bg-gray" data-owl-options="{'loop': false }">
      <div class="home-slide home-slide1 banner">
        <img class="owl-lazy slide-bg" src="" data-src="{{ asset('assets/web/images/slider/slide-1.jpg')}}" alt="slider image" width="1120" height="500"></img>
      ...
      <div class="home-slide home-slide2 banner">
        <img class="owl-lazy slide-bg" src="" data-src="{{ asset('assets/web/images/slider/slide-2.jpg')}}" alt="slider image" width="1120" height="500"></img>
    ...
    <div class="banners-section container mt-4">
      <div class="banners-slider owl-carousel owl-theme dots-mt-1" data-owl-options="{
        ...
        <div class="banner">
          <img src="{{ asset('assets/web/images/banners/banner1.jpg')}}" width="360" height="280" alt="category banner">
        ...
        <div class="banner">
          <img src="{{ asset('assets/web/images/banners/banner2.jpg')}}" width="360" height="280" alt="category banner">
          <div class="banner-content bg-dark text-center">
            <h5 class="m-b-1"><a href="category.html">Save Up To</a></h5>
        ...
        <div class="banner">
          <img src="{{ asset('assets/web/images/banners/banner3.jpg')}}" width="360" height="280" alt="category banner">
          <div class="banner-content bg-dark text-center">
            <h5 class="m-b-1"><a href="category.html">Save Up To</a></h5>
          ...
          <div class="tab-pane fade show active" id="featured-products" role="tabpanel" aria-labelledby="featured-products-tab">
            <div class="tab-products-carousel owl-carousel owl-theme quantity-inputs show-nav-hover nav-outer nav-image-center">
              ...
              <div class="product-default inner-quickview inner-icon quantity-input">
                <figure>
                  <a href="product.html">
                    <img src="{{ asset('assets/web/images/products/product-2.jpg') }}">
                  </a>
                  <div class="label-group">
                    <span class="product-label label-hot">HOT</span>
                  </div>
              ...
              <div class="product-default inner-quickview inner-icon quantity-input">
                <figure>
                  <a href="product.html">
                    <img src="{{ asset('assets/web/images/products/product-3.jpg') }}">
                  </a>
                  <div class="label-group">
                    <span class="product-label label-hot">HOT</span>
                  </div>
              ...
              <div class="product-default inner-quickview inner-icon quantity-input">
                <figure>
                  <a href="product.html">
                    <img src="{{ asset('assets/web/images/products/product-5.jpg') }}">
                  </a>
                  <div class="label-group">
                    <span class="product-label label-hot">HOT</span>
                    <span class="product-label label-sale">-30%</span>
              ...
              <div class="product-default inner-quickview inner-icon quantity-input">
                <figure>
                  <a href="product.html">
                    <img src="{{ asset('assets/web/images/products/product-4.jpg') }}">
                  </a>
                  <div class="label-group">
                    <span class="product-label label-hot">HOT</span>
            ...
            <div class="tab-products-carousel owl-carousel owl-theme quantity-inputs show-nav-hover nav-outer nav-image-center">
              <div class="product-default inner-quickview inner-icon quantity-input">
                <figure>
                  <a href="product.html">
                    <img src="{{ asset('assets/web/images/products/product-5.jpg') }}">
                    <img src="{{ asset('assets/web/images/products/product-5-2.jpg') }}">
                  </a>
                  <div class="label-group">
                    <span class="product-label label-hot">HOT</span>
                    <span class="product-label label-sale">-30%</span>
              ...
              <div class="product-default inner-quickview inner-icon quantity-input">
                <figure>
                  <a href="product.html">
                    <img src="{{ asset('assets/web/images/products/product-6.jpg') }}">
                  </a>
                  <div class="btn-icon-group">
                    <a href="#" class="btn-icon btn-icon-wish"><i class="icon-heart"></i></a>
                  </div>
              ...
              <div class="product-default inner-quickview inner-icon quantity-input">
                <figure>
                  <a href="product.html">
                    <img src="{{ asset('assets/web/images/products/product-7.jpg') }}">
                  </a>
                  <div class="btn-icon-group">
                    <a href="#" class="btn-icon btn-icon-wish"><i class="icon-heart"></i></a>
                  </div>
              ...
              <div class="product-default inner-quickview inner-icon quantity-input">
                <figure>
                  <a href="product.html">
                    <img src="{{ asset('assets/web/images/products/product-9.jpg') }}">
                  </a>
                  <div class="label-group">
                    <span class="product-label label-sale">-20%</span>
                  </div>
    ...
    <div class="promo-section bg-gray" data-parallax="{'speed': 1.5, 'enableOnMobile': true}" data-image-src="{{ asset('assets/web/images/banners/promo-bg.png') }}">
    ...
    <div class="container">
      <div class="brands-slider owl-carousel owl-theme images-center mt-4">
        <img src="{{ asset('assets/web/images/brands/brand1.png') }}" width="140" height="60" alt="brand">
        <img src="{{ asset('assets/web/images/brands/brand2.png') }}" width="140" height="60" alt="brand">
        <img src="{{ asset('assets/web/images/brands/brand3.png') }}" width="140" height="60" alt="brand">
        <img src="{{ asset('assets/web/images/brands/brand4.png') }}" width="140" height="60" alt="brand">
        <img src="{{ asset('assets/web/images/brands/brand5.png') }}" width="140" height="60" alt="brand">
        <img src="{{ asset('assets/web/images/brands/brand6.png') }}" width="140" height="60" alt="brand">
      ...
      <div class="product-widgets row pt-1 m-b-2 mb-6">
        <div class="col-md-4 col-sm-6 pb-5">
          ...
          <div class="product-default left-details product-widget mb-2">
            <figure>
              <a href="product.html">
                <img src="{{ asset('assets/web/images/products/small/product-1.jpg') }}" width="168" height="168">
              </a>
            </figure>
            <div class="product-details">
              <div class="category-list">
          ...
          <div class="product-default left-details product-widget mb-2">
            <figure>
              <a href="product.html">
                <img src="{{ asset('assets/web/images/products/small/product-2.jpg') }}" width="168" height="168">
              </a>
            </figure>
            <div class="product-details">
              <div class="category-list">
          ...
          <div class="product-default left-details product-widget mb-2">
            <figure>
              <a href="product.html">
                <img src="{{ asset('assets/web/images/products/small/product-3.jpg') }}" width="168" height="168">
              </a>
            </figure>
            <div class="product-details">
              <div class="category-list">
        ...
        <div class="col-md-4 col-sm-6 pb-5">
          ...
          <div class="product-default left-details product-widget mb-2">
            <figure>
              <a href="product.html">
                <img src="{{ asset('assets/web/images/products/small/product-4.jpg') }}" width="168" height="168">
              </a>
            </figure>
            <div class="product-details">
              <div class="category-list">
          ...
          <div class="product-default left-details product-widget mb-2">
            <figure>
              <a href="product.html">
                <img src="{{ asset('assets/web/images/products/small/product-5.jpg') }}" width="168" height="168">
              </a>
            </figure>
            <div class="product-details">
              <div class="category-list">
          ...
          <div class="product-default left-details product-widget mb-2">
            <figure>
              <a href="product.html">
                <img src="{{ asset('assets/web/images/products/small/product-6.jpg') }}" width="168" height="168">
              </a>
            </figure>
            <div class="product-details">
              <div class="category-list">
        ...
        <div class="col-md-4 col-sm-6 pb-5">
          ...
          <div class="product-default left-details product-widget mb-2">
            <figure>
              <a href="product.html">
                <img src="{{ asset('assets/web/images/products/small/product-7.jpg') }}" width="168" height="168">
              </a>
            </figure>
            <div class="product-details">
              <div class="category-list">
          ...
          <div class="product-default left-details product-widget mb-2">
            <figure>
              <a href="product.html">
                <img src="{{ asset('assets/web/images/products/small/product-8.jpg') }}" width="168" height="168">
              </a>
            </figure>
            <div class="product-details">
              <div class="category-list">
          ...
          <div class="product-default left-details product-widget mb-2">
            <figure>
              <a href="product.html">
                <img src="{{ asset('assets/web/images/products/small/product-9.jpg') }}" width="168" height="168">
              </a>
            </figure>
            <div class="product-details">
              <div class="category-list">
